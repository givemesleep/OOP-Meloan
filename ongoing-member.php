...
$page = 'ongoingMem'; $folder = 'membership';
require_once 'components/sidenav.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Ongoing Member</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Membership Information</a></li>
          <li class="breadcrumb-item active">On-Going Member</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title" style="font-size: 35px;"><strong>On-Going Member</strong></h5>
